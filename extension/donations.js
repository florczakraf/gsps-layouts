...
const donationsLog = new ((0, nodecg_1.get)().Logger)(`${(0, nodecg_1.get)().bundleName}:tracker`);
...
function updateToReadDonations() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const resp = yield (0, needle_1.default)('get', `https://gsps.pl/donacje/search?event=${config.eventID}&type=donation&feed=toread`, {
                cookies: cookies,
            });
...
function getDonationBids() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const resp = yield (0, needle_1.default)('get', `https://gsps.pl/donacje/search?event=${config.eventID}&type=donationbid`, {
                cookies: cookies,
            });
            return resp.body;
        }
...
function setDonationAsRead(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const resp = yield (0, needle_1.default)('get', `https://gsps.pl/donacje/edit?type=donation&id=${id}` +
