...
const prizesLog = new ((0, nodecg_1.get)().Logger)(`${(0, nodecg_1.get)().bundleName}:nagrody`);
...
function updatePrizes() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const resp = yield (0, needle_1.default)('get', `https://gsps.pl/donacje/search?event=${config.eventID}&type=prize`, {
