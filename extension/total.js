...
const totalLog = new ((0, nodecg_1.get)().Logger)(`${(0, nodecg_1.get)().bundleName}:total`);
const eventID = (_a = (0, nodecg_1.get)().bundleConfig.tracker) === null || _a === void 0 ? void 0 : _a.eventID;
